		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Weather App",
									"targetURL": "#Zweatherappweatherapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Zweatherappweatherapp-display": {
								"semanticObject": "Zweatherappweatherapp",
								"action": "display",
								"description": "UI5 project using a weather api",
								"title": "Weather App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Zweatherapp.weatherapp",
									"url": sap.ui.require.toUrl("Zweatherapp/weatherapp")
								}
							}
						}
					}
